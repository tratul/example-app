								...
								<table class="form-table" role="presentation" style="width: 100%;">
									<tbody>
										<tr class="form-field form-required mb-3">
											...
											<td><input name="user_login" type="text" id="user_login" class="form-control" value="salom" disabled="disabled" aria-required="true" autocapitalize="none" autocorrect="off" maxlength="60" /></td>
										</tr>
